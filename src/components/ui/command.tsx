  ...
  return (
    <Dialog {...props}>
      ...
      >
        ...
        <Command className="[&_[cmdk-group-heading]]:text-muted-foreground **:[cmdk-group-heading]:px-2 **:[cmdk-group-heading]:font-medium **:[cmdk-group]:px-2 **:[cmdk-group]:pb-1 **:[cmdk-input-wrapper]_svg:size-5 **:[cmdk-input]:h-12 **:[cmdk-item]:px-2 **:[cmdk-item]:py-3 **:[cmdk-item]_svg:size-5">
          {children}
        </Command>
      </DialogContent>
    </Dialog>
